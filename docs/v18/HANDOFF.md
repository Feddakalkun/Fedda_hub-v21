...
- docs/v18/ and handoff_latest.md (detailed history) deliberately excluded per "extremely clean and minimal at the start" rule.
- First commit will be the clean modular foundation.

## Latest Update - Workflow Standard Baseline (carried from v16)
- New workflows follow docs/v18/WORKFLOW_STANDARD.md (copy/adapt the proven template).
...
- Keep breadcrumbs updated in docs/v18/BREADCRUMBS.md.
